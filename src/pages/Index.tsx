...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-primary">
      {/* O flex-1 garante que o conteúdo principal expanda, empurrando o footer para o final */}
      ...
      {/* Footer fixado corretamente na base da tela */}
      <footer className="shrink-0 p-6 text-center text-primary-foreground/30 text-sm">
        IPB — Soli Deo Gloria
      </footer>
    </div>
  );
